//
// Created by iodim on 03/12/18.
//

#ifndef OPTITRACK_MOTIVE_2_CLIENT_NATNETDATATYPES_H
#define OPTITRACK_MOTIVE_2_CLIENT_NATNETDATATYPES_H
...
#endif //OPTITRACK_MOTIVE_2_CLIENT_NATNETDATATYPES_H
